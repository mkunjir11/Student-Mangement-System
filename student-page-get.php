   ...
   <body>    
       <?PHP
                    ...
                    try 
                    {
                        ...
                        $yearPass=$result2['yearPass'];
                        // disconnect from server
                        if($yearPass != 0 || $yearPass != "")
                        {
                            $alu=1;
                        }
        ...
        <div class="container">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row"> 
                 ...
                 <div class="col-md-2">
                     <Label style="font-size: large" for="classYear"><b>Class:</b></label>    
                 </div>
                 <div class="col-md-2">
...
?>
    ...
    <section>
        ...
        {
            ?>
<center><a href="aluinfo-get.php?cid=<?php echo $testid; ?>"><h4>View Career Information</h4></a></center>
    <?PHP
