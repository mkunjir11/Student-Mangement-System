       ...
       <?PHP
            ...
            {     
                try 
                {
                    ...
                    $resul2 = $collection2->findOne(array('_id' => $oldusernmae, 'password' => $oldpassword));
            ...
            <div class="container-fluid overlay">
                ...
                <b>
                    <ul class="nav navbar-nav navbar-right navbar-fixed">
                        <li><a href="aluinfo.php" class="page-scroll">Home</a></li>                
       ...
       <div class="container">
                ...
                <form method="post">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                    <Label style="font-size: medium " >Enter PRN : </label>                                  
