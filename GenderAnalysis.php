        ...
        <?php
            if($_SERVER["REQUEST_METHOD"]=="POST")  
            {
                ...
                try 
                {
                    ...
                    { 
                       $map = new MongoCode("function() { emit(this.gender,1); }");
			...
			"out" => 'test_mapreduce_gender'));
			
                        $users = $db->selectCollection('test_mapreduce_gender')->find();                      
                     ?>
			 <!-- load api -->
                        ...
                        <script type="text/javascript">
                            function drawVisualization() 
                            {
                                ...
                                new google.visualization.PieChart(document.getElementById('visualization')).
                                        draw(data, {title:"Gender Ratio of class <?PHP echo $class; ?> in Department <?PHP echo $dept;  ?>"});
                            }
